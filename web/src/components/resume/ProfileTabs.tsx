          ...
          {TABS.map((t) => {
            ...
            return (
              <button
                ...
                onClick={() => setTab(t)}
                style={{
                  fontFamily: "'Archivo',sans-serif", fontSize: 13.5, fontWeight: 600, padding: "15px 18px",
...
const headStyle: React.CSSProperties = { fontFamily: "'Newsreader',serif", fontSize: 16, fontWeight: 600 };
