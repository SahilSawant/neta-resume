      ...
      <section style={{ position: "relative", padding: "clamp(44px,7vw,72px) clamp(16px,5vw,48px) clamp(40px,6vw,56px)", overflow: "hidden", borderBottom: "1px solid var(--rule)" }}>
        ...
        <div style={{ position: "relative", maxWidth: 720, margin: "0 auto" }}>
          ...
          <div className="fadeUp nr-hero-actions" style={{ display: "flex", gap: 12, flexWrap: "wrap", alignItems: "stretch" }}>
            ...
            <Link href="/directory" className="btnDark" style={{ display: "inline-flex", alignItems: "center", fontFamily: "var(--font-serif)", fontSize: 14.5, fontWeight: 600, padding: "13px 24px", borderRadius: 10, border: "none", background: "var(--btn-bg)", color: "var(--btn-fg)", cursor: "pointer", textDecoration: "none" }}>
